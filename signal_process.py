...
def signal_process(audio_samples, sr=22050, method='spectrogram'):
    ...
    if method == 'own_way':
        ...
        spec_layer = torchaudio.transforms.Spectrogram(n_fft=8192, hop_length=4096, normalized=True)
        ...
        mfcc_layer = torchaudio.transforms.MFCC(sample_rate=sr, n_mfcc=80, melkwargs=melkwargs)
